...
from legacy import features
from legacy import camera
from legacy import structure
...
def dino():
    # Dino
    img1 = cv2.imread('imgs/dinos/viff.023.ppm')
    img2 = cv2.imread('imgs/dinos/viff.024.ppm')
