...
def plot_cube(points3d, title=''):
    ...
    ax = fig.add_subplot(111, projection='3d')  # 🛠 вот эта строка
    ax.set_aspect('auto')  # можно 'auto', если 'equal' вызывает ошибку
...
true_E = np.dot(structure.skew(translation_mat_wrt_c1.ravel()), rotation_mat_wrt_c1)
